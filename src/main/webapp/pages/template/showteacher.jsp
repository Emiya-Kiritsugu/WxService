...
<div class="container-fluid-full">
  <div class="box span4" onTablet="span6" onDesktop="span4">
    <div class="box-header">
      <h2><i class="halflings-icon user"></i><span class="break"></span>老师风采</h2>
      <div class="box-icon">
    ...
    <div class="box-content">
      <ul class="dashboard-list">
        ...
        <li class="mylist">
          <a href="#">
            <img class="avatar" alt="Dennis Ji" src="<%=teacher.getPhotoUrl() %>">
          </a>
          <p>
          <strong>姓名:</strong> <a href="#"><%=teacher.getName()%></a><br>
          <strong>成就:</strong> <%=teacher.getAchievement()%><br>
          <strong>简介:</strong> <%=teacher.getProfile()%><br>
          </p>
        </li>
        <% } %>
      </ul>
