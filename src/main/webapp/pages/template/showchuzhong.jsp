...
<div class="container-fluid-full">
  <div class="box span4" onTablet="span6" onDesktop="span4">
    <div class="box-header">
      <h2><i class="halflings-icon user"></i><span class="break"></span>初中课程</h2>
      <div class="box-icon">
    ...
    <div class="box-content">
      <div id="image-7" class="masonry-thumb">
        <a style="background:url(/staticSource/upload/chuzhong.png)" title="Sample Image 7" href="/staticSource/upload/chuzhong.png"><img class="grayscale" src="/staticSource/upload/chuzhong.png" alt="Sample Image 7"></a>
      </div>
    </div>
  </div><!--/span-->
</div>
