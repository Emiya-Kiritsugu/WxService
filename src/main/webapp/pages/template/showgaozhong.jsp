  ...
  <div class="box span4" onTablet="span6" onDesktop="span4">
    ...
    <div class="box-content">
      <div id="image-7" class="masonry-thumb">
        <a style="background:url(/staticSource/upload/gaozhong.png)" title="Sample Image 7" href="/staticSource/upload/gaozhong.png"><img class="grayscale" src="/staticSource/upload/gaozhong.png" alt="Sample Image 7"></a>
      </div>
    </div>
  </div><!--/span-->
</div>
