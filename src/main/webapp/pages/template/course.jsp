    ...
    <div id="sidebar-left" class="span2">
      <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
          ...
          <li class="active"><a href="/pages/template/course.jsp"><i class="icon-envelope"></i><span class="hidden-tablet"> 课程管理</span></a></li>
            ...
            <form class="form-horizontal" action="/view/course" method="post" enctype="multipart/form-data">
              <fieldset>
                <div class="control-group">
                  <label class="control-label" for="selectError3">选择年级</label>
                  <div class="controls">
                    <select id="selectError3" name="grade">
                      <option value="gaozhong.png">高中</option>
                      <option value="chuzhong.png">初中</option>
                      <option value="xiaoxue.png">小学</option>
                    </select>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label" for="fileInput">上传课表(*.png)</label>
                  <div class="controls">
                    <input class="input-file uniform_on" id="fileInput" type="file" name="course">
                  </div>
                </div>
                <div class="form-actions">
                  <button type="submit" class="btn btn-primary" onclick="alert('上传成功')">上传</button>
