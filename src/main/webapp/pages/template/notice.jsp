    ...
    <div id="sidebar-left" class="span2">
      <div class="nav-collapse sidebar-nav">
        <ul class="nav nav-tabs nav-stacked main-menu">
          ...
          <li class="active"><a href="/view/managecourse"><i class="icon-envelope"></i><span class="hidden-tablet"> 公告管理</span></a></li>
        </ul>
      </div>
    </div>
    <!-- end: Main Menu -->
...
<% String content = (String)request.getAttribute("content");%>
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="#">公告管理</a><i class="icon-angle-right"></i></li>
      </ul>
