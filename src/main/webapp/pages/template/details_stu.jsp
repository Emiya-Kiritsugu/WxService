            ...
            <form class="form-horizontal" action="/view/updatestudent" method="post" enctype="multipart/form-data">
              <fieldset>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input class="input-xlarge" readonly id="disabledInput" name="studentNo" type="text" value="<%=Student.getStuNo()%>">
                  </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group success">
                  ...
                  <div class="controls">
                    <input type="text" id="inputSuccess" name="school" value="<%=Student.getSchool()%>">
                ...
                <div class="control-group hidden-phone">
                  ...
                  <div class="controls">
                    <textarea class="cleditor" id="textarea2" name="achieve" rows="3"><%=Student.getAchievement()%></textarea>
                  </div>
                </div>
